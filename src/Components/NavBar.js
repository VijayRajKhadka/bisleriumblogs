...
const NavBar = () => {
    ...
    const [isDropNoti, setIsDropNoti] = useState(false);
    ...
    return <nav className="home-top-nav z-10">
        ...
        <div className="profile-container">
            <div className="noti-gap" onClick={toggleNotification} >
            ...
            {unreadNotification}
                ...
                {isDropNoti && (
                    ...
                    <div className="dropdown-noti-content z-10">
