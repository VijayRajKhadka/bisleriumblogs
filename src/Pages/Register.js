        ...
        <div>
            ...
            <div className='login-page-container '>
                <div className='login-container'>
                    <div className='flex wid-full justify-between items-center content-center'>
                        <div className="input-container" >
                            ...
                            {
                                firstNameError ? <span className="text-red-600">**{firstNameError}</span> : null
                            }
                        ...
                        <div className="input-container">
                            ...
                            {
                                lastNameError ? <span className="text-red-600">**{lastNameError}</span> : null
                            }
                            <span className="input-highlight"></span>
                        </div>
                    </div>
                    ...
                    <div className="input-container" style={{ width: '100%' }}>
                        ...
                        {
                            emailError ? <span className="text-red-600">**{emailError}</span> : null
                        }
                        <span className="input-highlight"></span>
                    </div>
                    ...
                    <div className='flex wid-full justify-between items-center content-center'>
                        ...
                        <div className="input-container">
                            ...
                            {
                                confirmPasswordError ? <span className="text-red-600">**{confirmPasswordError}</span> : null
                            }
                            <span className="input-highlight"></span>
                            <button
