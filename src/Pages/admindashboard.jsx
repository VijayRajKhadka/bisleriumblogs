    ...
    const fetchData = async () => {
      try {
        ...
        for (let month = 1; month <= 12; month++) {
          const response = await axios.get(`https://localhost:7216/api/admin/upvoteSum?month=${month}&year=2024`, {
            headers: {
              Authorization: `Bearer ${adminToken}`, // Include the admin token in the Authorization header
            },
          });
          data.push({ label: monthNames[month - 1], value: response.data.upvoteSum });
        }
        setSourceData(data);
      } catch (error) {
        console.error('Error fetching data:', error);
            ...
            <div className="left-div">
              <div className="top-users">
                <div className="user">
                  ...
                  <div className="user-bio">
                    "I love click photos and videos of beautiful people and
                    places"
                  </div>
                </div>
              </div>
              <div className="top-users">
                <div className="user">
                  ...
                  <div className="user-bio">
                    "Passionate about exploring new places and trying exotic
                    cuisines."
                  </div>
                </div>
              </div>
              <div className="top-users">
                <div className="user">
                  ...
                  <div className="user-bio">
                    "Tech enthusiast who loves coding and building cool
                    projects."
                  </div>
                </div>
              </div>
              <div className="top-users">
                <div className="user">
                  ...
                  <div className="user-bio">
                    "Bookworm by day, gamer by night. Always up for an
                    adventure."
                  </div>
                </div>
              </div>
              <div className="top-users">
                <div className="user">
                  ...
                  <div className="user-image">
                    <img
                      src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSqWtpaInVApJX83uiS6ZcNdp8R92LJjc9cEg&s"
                      alt="User"
                    />
                  </div>
                  <div className="user-name">
                  ...
                  <div className="user-bio">
                    "Fitness freak and adrenaline junkie. Living life one
                    workout at a time."
                  </div>
                </div>
              </div>
              ...
              <div className="top-users">
                <div className="user">
                  ...
                  <div className="user-bio">
                    "Music aficionado and aspiring musician. Never seen without
                    headphones."
                  </div>
                </div>
              </div>
              <div className="top-users">
                <div className="user">
                  ...
                  <div className="user-bio">
                    "Animal lover and nature enthusiast. Dreaming of traveling
                    the world."
                  </div>
                </div>
              </div>
              <div className="top-users">
                <div className="user">
                  ...
                  <div className="user-bio">
                    ""Foodie on a mission to find the best burger in town.
                    Burgers , Everything."
                  </div>
                </div>
              </div>
              <div className="top-users">
                <div className="user">
                  ...
                  <div className="user-image">
                    <img
                      src="https://media.istockphoto.com/id/1834732876/photo/young-black-businessman-walking-outside-with-cellphone-and-laptop-bag.jpg?s=612x612&w=0&k=20&c=NAx5IBLmJ9-M1BQN3s7mY_ThM-d3BXRUL-Fyb8iejBU="
                      alt="User"
                    />
                  </div>
                  <div className="user-name">
                  ...
                  <div className="user-bio">
                    "Fashionista with a passion for runway shows and haute
                    couture."
                  </div>
                </div>
              </div>
